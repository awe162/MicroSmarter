...
public class NumberPickerDialogLength extends Dialog implements OnClickListener {
    ...
    public NumberPickerDialogLength(Context context, OnMyNumberSetListener listener,
